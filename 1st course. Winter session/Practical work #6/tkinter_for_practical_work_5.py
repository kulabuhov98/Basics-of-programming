...
"""
    Алгоритм работает только с числами от 0 до 9, без полного удаления символа из поля ввода.
    Ввод последовательности осуществляется путем выделения и замены текущего символа в поле ввода.
"""
